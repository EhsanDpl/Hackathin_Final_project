...
async function bootstrap() {
  ...
  console.log(`  GET http://localhost:${port}/profile - Get current user profile (requires JWT token)`);
  console.log(`  PUT http://localhost:${port}/profile - Update profile and connect integrations (requires JWT token)`);
  console.log(`  POST http://localhost:${port}/employees - Create employee (requires JWT token)`);
  ...
  console.log(`  GET http://localhost:${port}/linkedinProfiles?learnerId=... - LinkedIn integration`);
  console.log(`  GET http://localhost:${port}/jiraData?learnerId=... - Jira integration`);
  console.log(`  GET http://localhost:${port}/teamsCalendar?learnerId=... - Teams integration`);
