        ...
        <div className="flex-1 flex flex-col overflow-auto">
         <Navbar title="Create Learner Link" />
          ...
          <main className="p-6 flex justify-center items-start">
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-2xl transform transition hover:scale-105">
              ...
              {selectedEmployee && (
                <div className="flex flex-col md:flex-row md:items-center space-y-3 md:space-y-0 md:space-x-3">
                  <input
                    ...
                    className="flex-1 bg-gray-100 p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
                  <button
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 bg-gray-300 hover:bg-gray-400 px-4 py-2 rounded-lg transition"
                  >
